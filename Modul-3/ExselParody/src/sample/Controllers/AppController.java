...
public class AppController {
    ...
    void initialize() {
        ...
        VB1_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_1));
        VB1_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_2));
        VB1_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_3));
        VB1_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_4));
        VB1_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_5));
        VB1_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_6));
        VB1_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_7));
        VB1_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_8));
        VB1_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_9));
        VB1_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB1_Column_10));

        VB2_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_1));
        VB2_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_2));
        VB2_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_3));
        VB2_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_4));
        VB2_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_5));
        VB2_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_6));
        VB2_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_7));
        VB2_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_8));
        VB2_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_9));
        VB2_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB2_Column_10));

        VB3_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_1));
        VB3_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_2));
        VB3_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_3));
        VB3_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_4));
        VB3_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_5));
        VB3_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_6));
        VB3_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_7));
        VB3_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_8));
        VB3_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_9));
        VB3_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB3_Column_10));

        VB4_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_1));
        VB4_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_2));
        VB4_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_3));
        VB4_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_4));
        VB4_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_5));
        VB4_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_6));
        VB4_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_7));
        VB4_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_8));
        VB4_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_9));
        VB4_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB4_Column_10));

        VB5_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_1));
        VB5_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_2));
        VB5_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_3));
        VB5_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_4));
        VB5_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_5));
        VB5_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_6));
        VB5_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_7));
        VB5_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_8));
        VB5_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_9));
        VB5_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB5_Column_10));

        VB6_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_1));
        VB6_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_2));
        VB6_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_3));
        VB6_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_4));
        VB6_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_5));
        VB6_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_6));
        VB6_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_7));
        VB6_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_8));
        VB6_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_9));
        VB6_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB6_Column_10));

        VB7_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_1));
        VB7_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_2));
        VB7_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_3));
        VB7_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_4));
        VB7_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_5));
        VB7_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_6));
        VB7_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_7));
        VB7_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_8));
        VB7_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_9));
        VB7_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB7_Column_10));

        VB8_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_1));
        VB8_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_2));
        VB8_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_3));
        VB8_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_4));
        VB8_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_5));
        VB8_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_6));
        VB8_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_7));
        VB8_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_8));
        VB8_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_9));
        VB8_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB8_Column_10));

        VB9_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_1));
        VB9_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_2));
        VB9_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_3));
        VB9_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_4));
        VB9_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_5));
        VB9_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_6));
        VB9_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_7));
        VB9_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_8));
        VB9_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_9));
        VB9_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB9_Column_10));

        VB10_Column_1.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_1));
        VB10_Column_2.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_2));
        VB10_Column_3.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_3));
        VB10_Column_4.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_4));
        VB10_Column_5.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_5));
        VB10_Column_6.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_6));
        VB10_Column_7.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_7));
        VB10_Column_8.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_8));
        VB10_Column_9.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_9));
        VB10_Column_10.setOnKeyTyped(event -> needToSaveColum.add(VB10_Column_10));
    }
